...
class ReplaceTest {
    UserProfile userProfile = new UserProfile(USER_ID, LAST_UPDATE_TIMESTAMP,
            ...
            new HashMap<>(Map.of(UserProfilePropertyName.valueOf("currentGold"), UserProfilePropertyValue.valueOf(100),
    ...
    void replace_valid() {
        ...
        newProperties.userProfileProperties.put(UserProfilePropertyName.valueOf("currentGold"), UserProfilePropertyValue.valueOf(500));
        newProperties.userProfileProperties.put(UserProfilePropertyName.valueOf("currentGems"), UserProfilePropertyValue.valueOf(2));
        ...
        UserProfilePropertyValue result = operationFactory.execute(operationRequest, oldProperties)
                .userProfileProperties.get(UserProfilePropertyName.valueOf("currentGold"));
